...
[![ci](https://github.com/cfregly/agent-harness-opt/actions/workflows/ci.yml/badge.svg)](https://github.com/cfregly/agent-harness-opt/actions/workflows/ci.yml)
[![license: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/cfregly/agent-harness-opt/blob/main/LICENSE)
...
![Supabase tool tuning demo](https://github.com/cfregly/agent-harness-opt/blob/main/demo.gif)

> [!TIP]
> Watch for the Supabase coverage audit, the DDL and RLS optimization cells, retained live result summary, packet checks, and final share URL. For playback controls, open [demo.mp4](https://github.com/cfregly/agent-harness-opt/blob/main/demo.mp4).

The featured example is the [Supabase MCP Database Tool Tuning full PR/evidence bundle](https://github.com/cfregly/agent-harness-opt/tree/main/evals/pr_packets/supabase_mcp_database_tool_tuning_2026-06-25). It shows an agent boundary that is easy to understand and high impact: schema-changing SQL should use `apply_migration`, not raw `execute_sql`. The demo is generated by [scripts/render_demo_gif.py](https://github.com/cfregly/agent-harness-opt/blob/main/scripts/render_demo_gif.py) from [demo.tape](https://github.com/cfregly/agent-harness-opt/blob/main/demo.tape).

## Share This

| Audience | Send this |
|---|---|
| Supabase maintainers | [Supabase finding](https://github.com/cfregly/agent-harness-opt/tree/main/docs/findings/supabase), [retained PR/evidence bundle](https://github.com/cfregly/agent-harness-opt/tree/main/evals/pr_packets/supabase_mcp_database_tool_tuning_2026-06-25), and [tool tuning note](https://github.com/cfregly/agent-harness-opt/blob/main/docs/supabase-mcp-tool-tuning.md) |
| Any MCP founder | [Founder Findings](https://github.com/cfregly/agent-harness-opt/tree/main/docs/findings) |
| A reviewer who wants the proof trail | [Confirmed Improvements](https://github.com/cfregly/agent-harness-opt/blob/main/docs/confirmed-improvements.md) |
| Someone evaluating the workflow | [Demo GIF](https://github.com/cfregly/agent-harness-opt/blob/main/demo.gif) or [demo.mp4](https://github.com/cfregly/agent-harness-opt/blob/main/demo.mp4) |
| Current frontier receipts | [Frontier stress receipts](https://github.com/cfregly/agent-harness-opt/blob/main/docs/frontier-stress-2026-07-01.md) across OpenAI, Gemini, and retained Anthropic Opus attempts |
...
surface, start with [Setup](https://github.com/cfregly/agent-harness-opt/blob/main/docs/setup.md)
and [Techniques](https://github.com/cfregly/agent-harness-opt/blob/main/docs/techniques.md).
...
1. Capture a real tool or skill surface as a matrix.
2. Run baseline and tuned variants across the same cases.
...
[Hill Descending And Climbing](https://github.com/cfregly/agent-harness-opt/blob/main/docs/hill-descending-and-climbing.md)
...
| Need | Open |
|---|---|
| Send a founder one clean finding | [Founder Findings](https://github.com/cfregly/agent-harness-opt/tree/main/docs/findings) |
| See every promoted win and guardrail | [Confirmed Improvements](https://github.com/cfregly/agent-harness-opt/blob/main/docs/confirmed-improvements.md) |
...
Every link in this table is public and can be sent directly. The finding folder is the founder-facing
summary. The full bundle points at the complete retained artifact set for that target, including a
PR/evidence packet where one has been generated.
...
|---|---|---|---|---|---|---|---|
| gstack | Confirmed improvement + current frontier stress receipt | [gstack finding](https://github.com/cfregly/agent-harness-opt/tree/main/docs/findings/gstack) | [gstack full PR/evidence bundle](https://github.com/cfregly/agent-harness-opt/tree/main/evals/pr_packets/gstack_skill_routing_2026-06-25) | [Matrix](https://github.com/cfregly/agent-harness-opt/blob/main/evals/targets/gstack/gstack_skill_selection_matrix.json) | [Live result](https://github.com/cfregly/agent-harness-opt/blob/main/evals/results/gstack_skill_matrix_live_2026-06-25.json), [current frontier stress](https://github.com/cfregly/agent-harness-opt/blob/main/evals/results/gstack_skill_matrix_frontier_available_live_2026-07-01.md), and [audit note](https://github.com/cfregly/agent-harness-opt/blob/main/docs/gstack-skill-routing-audit.md) | [Reproduction doc](https://github.com/cfregly/agent-harness-opt/blob/main/evals/pr_packets/gstack_skill_routing_2026-06-25/REPRODUCTION.md) | [PR body](https://github.com/cfregly/agent-harness-opt/blob/main/evals/pr_packets/gstack_skill_routing_2026-06-25/PR_BODY.md) |
| Supabase | Confirmed improvement | [Supabase finding](https://github.com/cfregly/agent-harness-opt/tree/main/docs/findings/supabase) | [Supabase full PR/evidence bundle](https://github.com/cfregly/agent-harness-opt/tree/main/evals/pr_packets/supabase_mcp_database_tool_tuning_2026-06-25) | [Matrix](https://github.com/cfregly/agent-harness-opt/blob/main/evals/model_matrix/supabase_mcp_database_tool_selection.json) | [Live result](https://github.com/cfregly/agent-harness-opt/blob/main/evals/results/supabase_mcp_ddl_boundary_live_2026-06-25.md), [current frontier stress](https://github.com/cfregly/agent-harness-opt/blob/main/evals/results/supabase_mcp_database_tool_selection_frontier_available_live_2026-07-01.md), and [note](https://github.com/cfregly/agent-harness-opt/blob/main/docs/supabase-mcp-tool-tuning.md) | [Reproduction doc](https://github.com/cfregly/agent-harness-opt/blob/main/evals/pr_packets/supabase_mcp_database_tool_tuning_2026-06-25/REPRODUCTION.md) | [PR body](https://github.com/cfregly/agent-harness-opt/blob/main/evals/pr_packets/supabase_mcp_database_tool_tuning_2026-06-25/PR_BODY.md) |
| InsForge | Confirmed improvement | [InsForge finding](https://github.com/cfregly/agent-harness-opt/tree/main/docs/findings/insforge) | [InsForge full PR/evidence bundle](https://github.com/cfregly/agent-harness-opt/tree/main/evals/pr_packets/insforge_mcp_tool_tuning_2026-06-28) | [Matrix](https://github.com/cfregly/agent-harness-opt/blob/main/evals/model_matrix/insforge_mcp_tool_selection.json) | [Receipt](https://github.com/cfregly/agent-harness-opt/blob/main/evals/results/insforge_mcp_tool_selection_2026-06-28.md) and [current frontier stress](https://github.com/cfregly/agent-harness-opt/blob/main/evals/results/insforge_mcp_tool_selection_frontier_available_live_2026-07-01.md) | [Reproduction doc](https://github.com/cfregly/agent-harness-opt/blob/main/evals/pr_packets/insforge_mcp_tool_tuning_2026-06-28/REPRODUCTION.md) | [PR body](https://github.com/cfregly/agent-harness-opt/blob/main/evals/pr_packets/insforge_mcp_tool_tuning_2026-06-28/PR_BODY.md) |
| Screenpipe | Confirmed improvement | [Screenpipe finding](https://github.com/cfregly/agent-harness-opt/tree/main/docs/findings/screenpipe) | [Screenpipe full PR/evidence bundle](https://github.com/cfregly/agent-harness-opt/tree/main/evals/pr_packets/screenpipe_mcp_tool_tuning_2026-06-28) | [Matrix](https://github.com/cfregly/agent-harness-opt/blob/main/evals/model_matrix/screenpipe_mcp_tool_selection.json) | [Receipt](https://github.com/cfregly/agent-harness-opt/blob/main/evals/results/screenpipe_mcp_tool_selection_2026-06-28.md) and [current frontier stress](https://github.com/cfregly/agent-harness-opt/blob/main/evals/results/screenpipe_mcp_tool_selection_frontier_available_live_2026-07-01.md) | [Reproduction doc](https://github.com/cfregly/agent-harness-opt/blob/main/evals/pr_packets/screenpipe_mcp_tool_tuning_2026-06-28/REPRODUCTION.md) | [PR body](https://github.com/cfregly/agent-harness-opt/blob/main/evals/pr_packets/screenpipe_mcp_tool_tuning_2026-06-28/PR_BODY.md) |
| Firecrawl | Confirmed improvement | [Firecrawl finding](https://github.com/cfregly/agent-harness-opt/tree/main/docs/findings/firecrawl) | [Firecrawl full PR/evidence bundle](https://github.com/cfregly/agent-harness-opt/tree/main/evals/pr_packets/firecrawl_mcp_tool_tuning_2026-06-25) | [Matrix](https://github.com/cfregly/agent-harness-opt/blob/main/evals/model_matrix/firecrawl_mcp_tool_selection.json) | [Live result](https://github.com/cfregly/agent-harness-opt/blob/main/evals/results/firecrawl_mcp_single_page_live_2026-06-25.md), [current frontier stress](https://github.com/cfregly/agent-harness-opt/blob/main/evals/results/firecrawl_mcp_tool_selection_frontier_available_live_2026-07-01.md), and [note](https://github.com/cfregly/agent-harness-opt/blob/main/docs/firecrawl-mcp-tool-tuning.md) | [Reproduction doc](https://github.com/cfregly/agent-harness-opt/blob/main/evals/pr_packets/firecrawl_mcp_tool_tuning_2026-06-25/REPRODUCTION.md) | [PR body](https://github.com/cfregly/agent-harness-opt/blob/main/evals/pr_packets/firecrawl_mcp_tool_tuning_2026-06-25/PR_BODY.md) |
| Zymtrace | Confirmed improvement + frontier stress receipt | [Zymtrace finding](https://github.com/cfregly/agent-harness-opt/tree/main/docs/findings/zymtrace) | [Zymtrace full PR/evidence bundle](https://github.com/cfregly/agent-harness-opt/tree/main/evals/pr_packets/zymtrace_mcp_tool_tuning_2026-06-30) | [Matrix](https://github.com/cfregly/agent-harness-opt/blob/main/evals/model_matrix/zymtrace_mcp_tool_selection.json) | [Live result](https://github.com/cfregly/agent-harness-opt/blob/main/evals/results/zymtrace_mcp_matrix_live_2026-06-30.json), [coverage](https://github.com/cfregly/agent-harness-opt/blob/main/evals/results/zymtrace_mcp_coverage_2026-06-30.md), [frontier stress](https://github.com/cfregly/agent-harness-opt/blob/main/evals/results/zymtrace_mcp_frontier_available_matrix_live_2026-07-01.md), and [all-provider attempt](https://github.com/cfregly/agent-harness-opt/blob/main/evals/results/zymtrace_mcp_frontier_all_providers_attempt_2026-07-01.md) | [Reproduction doc](https://github.com/cfregly/agent-harness-opt/blob/main/evals/pr_packets/zymtrace_mcp_tool_tuning_2026-06-30/REPRODUCTION.md) | [PR body](https://github.com/cfregly/agent-harness-opt/blob/main/evals/pr_packets/zymtrace_mcp_tool_tuning_2026-06-30/PR_BODY.md) |
| Humwork | Guardrail | [Humwork finding](https://github.com/cfregly/agent-harness-opt/tree/main/docs/findings/humwork) | [Humwork retained guardrail bundle](https://github.com/cfregly/agent-harness-opt/tree/main/evals/pr_packets/humwork_mcp_guardrail_2026-06-28) | [Matrix](https://github.com/cfregly/agent-harness-opt/blob/main/evals/model_matrix/humwork_mcp_tool_selection.json) | [Receipt](https://github.com/cfregly/agent-harness-opt/blob/main/evals/results/humwork_mcp_tool_selection_2026-06-28.md) and [current frontier stress](https://github.com/cfregly/agent-harness-opt/blob/main/evals/results/humwork_mcp_tool_selection_frontier_available_live_2026-07-01.md) | [Reproduction doc](https://github.com/cfregly/agent-harness-opt/blob/main/evals/pr_packets/humwork_mcp_guardrail_2026-06-28/REPRODUCTION.md) | [No-change packet](https://github.com/cfregly/agent-harness-opt/blob/main/evals/pr_packets/humwork_mcp_guardrail_2026-06-28/PR_BODY.md) |
| OpenWork | Guardrail | [OpenWork finding](https://github.com/cfregly/agent-harness-opt/tree/main/docs/findings/openwork) | [OpenWork retained guardrail bundle](https://github.com/cfregly/agent-harness-opt/tree/main/evals/pr_packets/openwork_ui_mcp_guardrail_2026-06-28) | [Matrix](https://github.com/cfregly/agent-harness-opt/blob/main/evals/model_matrix/openwork_ui_mcp_tool_selection.json) | [Receipt](https://github.com/cfregly/agent-harness-opt/blob/main/evals/results/openwork_ui_mcp_tool_selection_2026-06-28.md) and [current frontier stress](https://github.com/cfregly/agent-harness-opt/blob/main/evals/results/openwork_ui_mcp_tool_selection_frontier_available_live_2026-07-01.md) | [Reproduction doc](https://github.com/cfregly/agent-harness-opt/blob/main/evals/pr_packets/openwork_ui_mcp_guardrail_2026-06-28/REPRODUCTION.md) | [No-change packet](https://github.com/cfregly/agent-harness-opt/blob/main/evals/pr_packets/openwork_ui_mcp_guardrail_2026-06-28/PR_BODY.md) |
...
plus recognized unique matrix-summary, tool, and check-family tables when JSON evidence backs them, checks matrix-coverage receipt structure,
...
`scripts/check_human_docs.py` keeps public Markdown human-first. It requires root docs to put demo,
share links, quickstart, and bundle links before machine-readable detail, requires sendable findings
and PR packets to include the founder handoff, local-agent CTA, and evidence bundle in that order,
and requires machine-heavy docs to move checker, eval, schema, and receipt detail into the bottom
LLM disclosure.

`scripts/check_artifact_surfaces.py` protects tracked non-code artifacts. It validates
`demo.gif` against [demo.tape](https://github.com/cfregly/agent-harness-opt/blob/main/demo.tape)
and [scripts/render_demo_gif.py](https://github.com/cfregly/agent-harness-opt/blob/main/scripts/render_demo_gif.py),
rejects transcript-reader or secret-bearing demo commands, requires the demo to stay public from the
README, and makes sure committed result receipts are reachable from public docs or PR packet text.
...
| Topic | Doc |
|---|---|
| GitHub MCP baseline | [GitHub MCP Tool Tuning](https://github.com/cfregly/agent-harness-opt/blob/main/docs/github-mcp-tool-tuning.md) |
| Firecrawl finding | [Firecrawl MCP Tool Tuning](https://github.com/cfregly/agent-harness-opt/blob/main/docs/firecrawl-mcp-tool-tuning.md) |
| Supabase finding | [Supabase MCP Tool Tuning](https://github.com/cfregly/agent-harness-opt/blob/main/docs/supabase-mcp-tool-tuning.md) |
| Screenpipe finding | [Screenpipe MCP Tool Tuning](https://github.com/cfregly/agent-harness-opt/blob/main/docs/screenpipe-mcp-tool-tuning.md) |
| InsForge finding | [InsForge MCP Tool Tuning](https://github.com/cfregly/agent-harness-opt/blob/main/docs/insforge-mcp-tool-tuning.md) |
| Tool-selection optimizer | [Tool Selection Optimization](https://github.com/cfregly/agent-harness-opt/blob/main/docs/tool-selection-optimization.md) |
| Trace review | [Trace Review](https://github.com/cfregly/agent-harness-opt/blob/main/docs/trace-review.md) |
| Model matrix | [Model Matrix](https://github.com/cfregly/agent-harness-opt/blob/main/docs/model-matrix.md) |
| Upstream PR packets | [Upstream PR Flywheel](https://github.com/cfregly/agent-harness-opt/blob/main/docs/upstream-pr-flywheel.md) |
| Failure discovery and optimization | [Hill Descending And Climbing](https://github.com/cfregly/agent-harness-opt/blob/main/docs/hill-descending-and-climbing.md) |
| Legacy hill-climb link | [Moved: Hill Descending And Climbing](https://github.com/cfregly/agent-harness-opt/blob/main/docs/autoresearch-hill-climbing.md) |
| Harness imports | [Repeatable Harness Lab](https://github.com/cfregly/agent-harness-opt/blob/main/docs/repeatable-harness-lab.md) |
| Live CLI harnesses | [Live Harness Hardening](https://github.com/cfregly/agent-harness-opt/blob/main/docs/live-harness-hardening.md) |
| SDK harnesses | [SDK Harness Coverage](https://github.com/cfregly/agent-harness-opt/blob/main/docs/sdk-harness-coverage.md) |
| Agent SDK reference | [Agent SDK Harnesses](https://github.com/cfregly/agent-harness-opt/blob/main/docs/agent-sdk-harnesses.md) |
| Service probes | [Credentialed Service Probes](https://github.com/cfregly/agent-harness-opt/blob/main/docs/credentialed-service-probes.md) |
...
result-row shape and identity, Markdown cell summaries, unique required coverage summary lines, matrix-coverage receipt item and gap-bucket structure, complete coverage gap labels and recognized unique required coverage tables, coverage-suite
...
[docs/findings/zymtrace](https://github.com/cfregly/agent-harness-opt/tree/main/docs/findings/zymtrace).
...
[docs/findings](https://github.com/cfregly/agent-harness-opt/tree/main/docs/findings).
...
other harnesses. See [Harness Optimization](https://github.com/cfregly/agent-harness-opt/blob/main/docs/harness-optimization.md) for the adapter
and upgrade loop.
...
[Source Map](https://github.com/cfregly/agent-harness-opt/blob/main/docs/source-map.md) for the source list and timestamps used while building the
repo. See [Video Coverage Audit](https://github.com/cfregly/agent-harness-opt/blob/main/docs/video-coverage-audit.md) for the implementation
