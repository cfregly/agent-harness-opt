...
coverage Markdown summaries backed by sibling JSON receipts, retained coverage gap bullets,
...
result-row shape and identity, Markdown cell summaries, required coverage summary lines, matrix-coverage receipt item and gap-bucket structure, complete coverage gap labels and required coverage tables, coverage-suite
